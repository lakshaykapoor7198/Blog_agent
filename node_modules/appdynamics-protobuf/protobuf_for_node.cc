...
public:
  ...
  public:
        ...
        : schema_(schema), descriptor_(descriptor)
    {
      ...
      constructor->Set(Nan::New<String>("parse").ToLocalChecked(),
                       bind->Call(parseTemplate->GetFunction(), 1, &arg));
      constructor->Set(Nan::New<String>("serialize").ToLocalChecked(),
                       bind->Call(serializeTemplate->GetFunction(), 1, &arg));
      ...
      switch (field->cpp_type()) {
        ...
        case FieldDescriptor::CPPTYPE_ENUM:
          const google::protobuf::EnumValueDescriptor* enum_value =
              value->IsNumber() ? field->enum_type()->FindValueByNumber(value->Int32Value())
